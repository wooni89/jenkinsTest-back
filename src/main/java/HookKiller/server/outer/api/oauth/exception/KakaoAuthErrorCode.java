package HookKiller.server.outer.api.oauth.exception;

import HookKiller.server.common.dto.ErrorDetail;
import HookKiller.server.common.exception.BaseErrorCode;
import HookKiller.server.outer.api.oauth.dto.StaticVal;
...
public enum KakaoAuthErrorCode implements BaseErrorCode {
    KOE101(
            StaticVal.BAD_REQUEST.getValue(),
            "KAKAO_KOE101",
            "invalid_client",
    ...
    KOE_INVALID_REQUEST(
            StaticVal.BAD_REQUEST.getValue(), "KAKAO_KOE_INVALID_REQUEST", "invalid_request", "잘못된 요청인 경우"),
    KOE400(
            StaticVal.BAD_REQUEST.getValue(),
            "KAKAO_KOE400",
            "invalid_token",
    ...
    KOE402(StaticVal.BAD_REQUEST.getValue(), "KAKAO_KOE402", "invalid_token", "서명이 올바르지 않아 유효한 ID 토큰이 아닌 경우"),
    KOE403(StaticVal.BAD_REQUEST.getValue(), "KAKAO_KOE403", "invalid_token", "만료된 ID 토큰인 경우");
